...
namespace ProyectoSistemaInventarioWeb.Controllers
{
    public class InventarioController : Controller
    {
        ...
        public InventarioController(SistemaInventarioContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaInventarioContext = _context.Inventarios.Include(i => i.IdProductoNavigation).Include(i => i.IdProveedorNavigation);
