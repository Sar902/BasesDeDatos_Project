...
namespace ProyectoSistemaInventarioNuevo.Controllers
{
    public class InventarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdInventario,IdProducto,IdProveedor,Cantidad,CantidadDisponible,PrecioCompra,FechaEntrada,FechaSalida,Estado")] Inventario inventario)
        {
