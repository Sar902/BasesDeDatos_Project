...
namespace ProyectoSistemaInventarioWeb.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public ProductoController(SistemaInventarioContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaInventarioContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,IdCategoria,Nombre,Cantidad,Estado")] Producto producto)
        {
