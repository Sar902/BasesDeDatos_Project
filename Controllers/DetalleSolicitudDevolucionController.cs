...
namespace ProyectoSistemaInventarioWeb.Controllers
{
    public class DetalleSolicitudDevolucionController : Controller
    {
        ...
        public DetalleSolicitudDevolucionController(SistemaInventarioContext context)
        {
            _context = context;
        }
        ...
        {
            var sistemaInventarioContext = _context.DetalleSolicitudDevolucions.Include(d => d.IdProductoNavigation).Include(d => d.IdSolicitudDevolucionNavigation);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var detalleSolicitudDevolucion = await _context.DetalleSolicitudDevolucions
                .Include(d => d.IdProductoNavigation)
                .Include(d => d.IdSolicitudDevolucionNavigation)
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdSolicitudDevolucion"] = new SelectList(_context.SolicitudDevolucions, "IdSolicitudDevolucion", "IdSolicitudDevolucion");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDetalleSolicitudDevolucion,IdSolicitudDevolucion,IdProducto,MotivoRechazo,CantidadSolicitada,CantidadAceptada,PrecioCompraUnitario,EstadoItem")] DetalleSolicitudDevolucion detalleSolicitudDevolucion)
        {
            ...
            ViewData["IdProducto"] = new SelectList(_context.Productos, "IdProducto", "IdProducto", detalleSolicitudDevolucion.IdProducto);
            ViewData["IdSolicitudDevolucion"] = new SelectList(_context.SolicitudDevolucions, "IdSolicitudDevolucion", "IdSolicitudDevolucion", detalleSolicitudDevolucion.IdSolicitudDevolucion);
            return View(detalleSolicitudDevolucion);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var detalleSolicitudDevolucion = await _context.DetalleSolicitudDevolucions.FindAsync(id);
            if (detalleSolicitudDevolucion == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (detalleSolicitudDevolucion != null)
            {
                _context.DetalleSolicitudDevolucions.Remove(detalleSolicitudDevolucion);
            }
        ...
        {
            return _context.DetalleSolicitudDevolucions.Any(e => e.IdDetalleSolicitudDevolucion == id);
        }
    }
}
