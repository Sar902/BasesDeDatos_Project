...
namespace ProyectoSistemaInventarioWeb.Controllers
{
    public class ProveedorController : Controller
    {
        ...
        public ProveedorController(SistemaInventarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Contacto,Estado")] Proveedor proveedor)
        {
